#Didnt solve this one myself. Got stuck many times and needed all 3 hints. 
#Couldn't think of brute force solution -> also had wrong understanding of polish notation -> knew something
#was possible and disregarded it for no reason... :( ?????
class Solution:
